...
#CA_of_interest <- c("Renfrewshire", "Glasgow City")
...
for (count in seq_along(CA_of_interest)){ 
  arglist_i <- list(rates_permonth, index=count, delay_reason=delay_reasons_list[[2]], CA_of_interest = CA_of_interest_named_vec[count])
