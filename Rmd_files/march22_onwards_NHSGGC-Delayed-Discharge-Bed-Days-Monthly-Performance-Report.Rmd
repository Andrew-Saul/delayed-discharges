...
# current_fy used for header outputs
...
fytd_standard_app <- create_appendix(tib =df_main, delay_reason = delay_reasons_list[1], mon = params$Report_month, FYTD_flag = TRUE)

mon_standard_app <- create_appendix(tib =df_main, delay_reason = delay_reasons_list[1], mon = params$Report_month, FYTD_flag = FALSE)
```
...
```{r}
create_CArate_plot(code9_mon[[3]], delay_reason = delay_reasons_list[[2]],  mon = params$Report_month, FYTD_flag = FALSE,
                   g_rate = code9_mon[[2]], s_rate = code9_mon[[1]]) 
...
```{r}
create_CArate_plot(code9_fytd[[3]], delay_reason = delay_reasons_list[[2]],  mon = params$Report_month, FYTD_flag = TRUE, g_rate = code9_fytd[[2]], s_rate = code9_fytd[[1]]) 
