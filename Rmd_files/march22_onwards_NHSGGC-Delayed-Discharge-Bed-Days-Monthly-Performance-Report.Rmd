...
for (count in seq_along(CA_of_interest)){ 
  arglist_i <- list(all_rates, index=count, CNeeds_string=CNeeds_list[[1]], CA_of_interest = CA_of_interest_named_vec[count])
