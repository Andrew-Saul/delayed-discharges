...
data_filename <- "beddays_occupied_tables_to_march_2022 v2"
...
```{r convert-to-tibbles, message=FALSE, warning=FALSE}
...
raw_tib <- create_mod_FY_authority(xl_file, sheet_name = "raw_data_to_mar_2022") 
...
A total of  `r get_written_summary_data(fytd_code9_rate_changes, scot_ggc_code9_fytd[[1]][[1]])[[1]]` of 6 NHSGGC HSCPs have rates above the Scotland average. <br /> 
`r if (get_written_summary_data(fytd_code9_rate_changes, scot_ggc_code9_fytd[[1]][[1]])[[1]]>0) {paste("They are",paste0( get_written_summary_data(fytd_code9_rate_changes, scot_ggc_code9_fytd[[1]][[1]])[[2]], collapse = ", "))}`.
...
A total of  `r get_written_summary_data(mon_code9_rate_changes, scot_ggc_code9_mon[[1]][[1]])[[1]]` of 6 NHSGGC HSCPs have rates above the Scotland average. <br /> 
`r if (get_written_summary_data(mon_code9_rate_changes, scot_ggc_code9_mon[[1]][[1]])[[1]]>0) {paste("They are",paste0( get_written_summary_data(mon_code9_rate_changes, scot_ggc_code9_mon[[1]][[1]])[[2]], collapse = ", "))}`.
...
A total of  `r get_written_summary_data(fytd_standard_rate_changes, scot_ggc_standard_fytd[[1]][[1]])[[1]]` of 6 NHSGGC HSCPs have rates above the Scotland average. <br /> 
`r if (get_written_summary_data(fytd_standard_rate_changes, scot_ggc_standard_fytd[[1]][[1]])>0) {paste("They are",paste0( get_written_summary_data(fytd_standard_rate_changes, scot_ggc_standard_fytd[[1]][[1]])[[2]], collapse = ", "))}`.
...
A total of  `r get_written_summary_data(mon_standard_rate_changes, scot_ggc_standard_mon[[1]][[1]])[[1]]` of 6 NHSGGC HSCPs have rates above the Scotland average. <br /> `r if (get_written_summary_data(mon_standard_rate_changes, scot_ggc_standard_mon[[1]][[1]])[[1]]>0) {paste("They are", paste0( get_written_summary_data(scot_ggc_standard_mon)[[2]], collapse = ", "))}`.
